 ...
 *
 * @checksum - beb52dc70960670fd13f34995a69887e7c412a4be725ed8da5031100b0f596a6
 * @variables - radius=rounded-2xl,accentColor=blue,colorTemperature=neutral,spacing=2,scale=lg,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 */
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  range__input: {
    ...
    "[&::-webkit-slider-runnable-track]:rounded-2xl": true,
    ...
    "[&::-moz-range-track]:rounded-2xl": true,
  ...
  togglebuttons__input: {
    ...
    "group-data-[vertical=false]/options:group-first/option:!rounded-2xl": true,
    ...
    "group-data-[vertical=true]/options:group-first/option:!rounded-br-none":
      true,
    "group-data-[vertical=false]/options:group-last/option:!rounded-2xl": true,
