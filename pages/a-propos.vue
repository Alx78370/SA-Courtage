<template>
  <div>
    ...
    <section class="px-5 py-10 lg:h-sectionlg xl:h-sectionxl flex justify-center items-center w-screen md:w-[90%] lg:w-[80%] xl:w-2/3 md:mx-auto">
      <article class="text-lg md:text-xl ">
        <div>
          ...
          <p class="pb-5">
            Ma disponibilité, ma réactivité, mon expérience et mon expertise vous
            accompagneront dans chaque étape du financement, jusqu'à la remise des
            clés de votre bien.
          </p>
          <p class="pb-5">
    ...
    <section class="px-5 bg-white ">
      <div class="flex flex-col justify-center items-center w-screen md:w-[90%] lg:w-[80%] xl:w-2/3 md:mx-auto py-20">
        <h2 class="text-center text-2xl md:text-3xl font-semibold px-5 pb-10">Mes engagements</h2>
        <div class="flex justify-center py-10">
          <ul class="grid grid-cols-1 gap-32 md:grid-cols-2 lg:grid-cols-3">
          <AdvantageItem
            icon="mdi:clock-fast"
          ...
          <AdvantageItem
            ...
            text="Gain de temps, gain d’argent."
          />
